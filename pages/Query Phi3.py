...
# Display chat messages from history on app rerun
    for message in st.session_state.messages_phi:
    ...
    if user_query := st.chat_input("Enter your queries here"):
        ...
        st.session_state.messages_phi.append({"role": "user", "content": user_query})
        ...
        st.session_state.messages_phi.append({"role": "assistant", "content": answer})
